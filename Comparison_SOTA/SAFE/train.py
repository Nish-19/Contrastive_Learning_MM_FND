...
tf.compat.v1.flags.DEFINE_integer("num_epochs", 10, "Number of training epochs (Default: 100)")
        ...
        with sess.as_default():
            ...
            for epoch in range(FLAGS.num_epochs):
                ...
                for i in range(5):  # 5-fold
                    ...
                    #NOTE: Not working
                    # # training set
                    # # layer.merged is none
                    # tf.summary.scalar("loss", layer.loss)
...
def main(_):
    ...
    x_head_train, x_head_test, y_train, y_test = train_test_split(x_head, y_cat, test_size=0.2, random_state=43)
    x_body_train, x_body_test, x_image_train, x_image_test = train_test_split(x_body, x_image, test_size=0.2, random_state=43)
