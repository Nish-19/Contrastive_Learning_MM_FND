...
def stopwordslist(filepath = '/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/stop_words.txt'):
    stopwords = {}
    for line in open(filepath, 'r').readlines():
        line = line.strip() # was unicode initially
        stopwords[line] = 1
...
def read_image():
    image_list = {}
    file_list = ['/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/nonrumor_images/', '/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/rumor_images/']
...
def write_txt(data):
    f = open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/top_n_data.txt", 'wb')
    for line in data:
        for l in line:
            f.write(l+"\n")
        f.write("\n")
...
def write_data(flag, image, text_only):
    ...
    def read_post(flag):
        ...
        pre_path = "/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/tweets/"
        # file_list = [pre_path + "test_nonrumor.txt", pre_path + "test_rumor.txt", \
        #                  pre_path + "train_nonrumor.txt", pre_path + "train_rumor.txt"] # original
        file_list = [pre_path + "nis_test_real.txt", pre_path + "nis_test_fake.txt", \
                         pre_path + "nis_train_real.txt", pre_path + "nis_train_fake.txt"]
        if flag == "train":
            id = pickle.load(open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/nis_train_id.pickle", 'rb'))
        elif flag == "validate":
            id = pickle.load(open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/nis_validate_id.pickle", 'rb'))
        elif flag == "test":
            id = pickle.load(open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/nis_test_id.pickle", 'rb'))
            ...
            for i, l in enumerate(f.readlines()):
                ...
                if (i + 1) % 3 == 0:
                    ...
                    if len(clean_l) > 10 and line_data[0] in id:
                        ...
                        line_data.append(l) # original post
                        line_data.append(clean_l) # post text
                        line_data.append(label) # label
        ...
        for i, id in enumerate(post['post_id']):
            ...
            if text_only or image_id in image:
                if not text_only:
                    ...
                    ordered_image.append(image[image_name]) # Place where image loading happens
...
def get_data(text_only):
    ...
    if text_only:
        ...
        # image_list = read_image() # dictionary
        image_list = pickle.load(open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/nis_image.pickle", 'rb'))
    ...
    #
    #
    word_embedding_path = "/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/w2v.pickle"

    # w2v = pickle.load(io.open(word_embedding_path, 'rb', encoding="utf-8"))
    with open(word_embedding_path, "rb") as fd:
        w2v = pickle.load(fd, fix_imports=True, encoding="latin1") # 32 dimension vectors
    ...
    # file_path = "/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/event_clustering.pickle"
    ...
    # NOTE: Adding unknown words to dict here
    add_unknown_words(w2v, vocab)
    W, word_idx_map = get_W(w2v)
    # # rand_vecs = {}
    # # add_unknown_words(rand_vecs, vocab)
    W2 = rand_vecs = {}
    w_file = open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/word_embedding.pickle", "wb")
...
#     # #
#     # #
#     # word_embedding_path = "/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/word_embedding.pickle"
...
#     # # # add_unknown_words(rand_vecs, vocab)
#     # W2 = rand_vecs = {}
#     # pickle.dump([W, W2, word_idx_map, vocab, max_l], open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/word_embedding.pickle", "wb"))
