...
def main(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (validate_data, validate_labels, event_labels) in enumerate(validate_loader):
            ...
            # vali_cost_vector.append(vali_loss.data[0]) # original
            vali_cost_vector.append(vali_loss.data.item())
                #validate_accuracy = (validate_labels == validate_argmax.squeeze()).float().mean()
            # validate_acc_vector_temp.append(validate_accuracy.data[0]) # original
...
def parse_arguments(parser):
    ...
    parser.add_argument('--text_only', type=bool, default= False, help='') # default False
    ...
    parser.add_argument('--event_num', type=int, default=10, help='') # default 10
...
def get_top_post(output, label, test_id, top_n = 500):
    ...
    pickle.dump(top_n_id_dict, open("/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo//top_n_id.pickle", "wb"))
...
def load_data(args):
    ...
    #print(train[4][0])
    word_vector_path = '/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo/word_embedding.pickle'
...
if __name__ == '__main__':
    ...
    train = '' 
    test = ''
    output = '/sda/rina_1921cs13/Nischal/NovFake/sota_comp/EANN-KDD18/Data/weibo//RESULT/'
